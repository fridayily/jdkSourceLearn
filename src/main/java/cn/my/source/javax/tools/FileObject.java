...
public interface FileObject {
     ...
     * the user writes the filename {@code "BobsApp\HashMapTest.java"} on
     * the command line, this method should return {@code
     * "BobsApp\HashMapTest.java"} whereas the {@linkplain #toUri toUri}
     * method might return {@code
     * file:///C:/Documents%20and%20Settings/UncleBob/BobsApp/HashMapTest.java}.
     *
